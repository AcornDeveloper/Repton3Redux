...
.repton1                                ;repton loader
 EQUS "bbc master 128/master compact repton 3 redux © superior software ltd / superior interactive 1986-2023 "
 EQUS "version 1.1 assembled on "
 EQUS TIME$

.repton1_execute
 JSR machine_type                       ;must be master 128/master compact
...
.machine_type
 ...
 BRK                                    ;error message
 EQUB &FF
 EQUS "Master 128/Master Compact machines only.", &00
