...
.worth                                  ;repton movement loop x4
 ...
 BRA worth                              ;keep moving four units
...
.update_repton                          ;after walking four units do final update
 STZ movie                              ;zeroise repton movement counter
...
.repton_action                          ;get the action code for what needs to be done
 ...
 TAX
 TYA                                    ;map byte into a
 JMP (reptn_addrs,X)                    ;vector to action

.reptn_addrs
 EQUW remove_graphic                    ;00 just remove graphic underneath repton
 EQUW remove_graphic                    ;01
 EQUW picked_diamond                    ;02
 EQUW picked_capsule                    ;03
 EQUW picked_keys                       ;04
 EQUW picked_transporter                ;05
 EQUW picked_crown                      ;06
 EQUW picked_death                      ;07
 EQUW picked_time_bomb                  ;08
...
.picked_crown                           ;picked a crown
 ...
 BRA remove_graphic_no_check            ;remove crown
...
.decrement_lower
 DEC diamn
 BRA remove_graphic_no_check            ;remove diamond graphic
