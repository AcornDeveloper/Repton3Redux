...
.find_spirits
 ...
 STA spirp,X
 STZ spirc,X
 STZ spirit_flags,X                     ;clear flags
 LDA #&01
 STA spird,X
 LDA #&03
 STA count,X
...
.spirit_repton_check
 ...
 BNE spirit_flash                       ;no
 BIT spirit_flags,X                     ;spirit moving between squares when map/status/killed used?
 BPL spirit_okay_to_choose              ;no
 STZ spirit_flags,X                     ;reset
 BRA spirit_flash
